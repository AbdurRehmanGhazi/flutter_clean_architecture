...
import 'package:flutter_clean_architecture/core/validators/confirm_password_validator.dart';
...
class RegistrationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: _RegistrationView(mobileNumber: mobileNumber),
    );
  }
}
...
class _RegistrationView extends StatefulWidget {
  final String mobileNumber;
  const _RegistrationView({super.key, required this.mobileNumber});
